% IMPORTANT NOTE
% This example is taken from Mathworks website. All rights retained by
% Mathworks.
...
if strcmpi(channel,"OverTheAir")
    deviceName = "Pluto";
    channelNumber = 5;
    frequencyBand = 2.4; % Will be hard overridden on line 113
    txGain = -10;
    rxGain = 40;
...
%imFig.Position = [0 1250 1200 670];
...
msduLength = 2304; % MSDU length in bytes. Max is 2304
...
if strcmpi(channel,"OverTheAir")
    ...
    sdrTransmitter.CenterFrequency = 1e9; % The Pluto is configured to always operate at 1 GHz center frequency.
